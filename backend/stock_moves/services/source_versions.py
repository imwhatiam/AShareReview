...
layer they are all allowed to depend on. This module used to keep a hand-copied
duplicate here, which meant a fix to the lookup had to be applied three times.
"""
